...
$document.ready(function () {
  ...
  if (plugins.rdMailForm.length) {
    var i, j, k,
        msg = {
          'MF000': 'Сообщение успешно отправлено!',
...
$(document).ready(function(){
    ...
    $(".used-technics-main-page .owl-stage > .owl-item").css("height", $(".used-technics-main-page .owl-stage > .owl-item").css("width"));
    
    $(".product-main-photo > img").height(($(".product-main-photo > img").width())/2);

    if( $(".single-post-photo > div, .about-component-img, .stalker-club-slider-slide, .photo-post-slider-slide").attr("background") ) {

        $(".single-post-photo > div").height( ($(".single-post-photo").width())/2 );

        $(".about-component-img").height( ($(".about-component-img").width())/1.5 );

        $(".stalker-club-slider-slide, .photo-post-slider-slide").height( ($(".stalker-club-slider-slide, .photo-post-slider-slide").width())/1.5 );

    }

    $("header nav").find("a[href$='"+$(".urkaffa-breadcrumbs ul li:nth-child(2) a").attr("href")+"']").closest("li").addClass("active");
    $("header nav").find("a[href^=http]").closest("li").removeClass("active");

    $("footer").find("a[href$='about']").attr("href", "/about/about-urkaffa");
    $(".urkaffa-breadcrumbs").find("a[href$='about']").attr("href", "/index.php#about-company");
   
    $("footer").find("a[href$='services-and-facilities']").attr("href", "/services-and-facilities/service-centers");
    $(".urkaffa-breadcrumbs").find("a[href$='services-and-facilities']").attr("href", "/index.php#services-and-facilities");

    $("a.forbiden").click(function(){
        return false;
    });

    if( $(".product-photo-slider .product-photo-slider-single").length <= 1 ) {

		$(".product-photo-slider .owl-prev").hide();
		$(".product-photo-slider .owl-next").hide();
...
$(window).on("load resize", function(){
	...
	$(".product-photo-slider .owl-item .product-photo-slider-single").width($(".product-photo-slider .owl-item.active").width());
	
	$(".product-photo-slider .owl-item .product-photo-slider-single").height($(".product-photo-slider .owl-item.active").width()/2);

});

function productPhotoSliderSizer() {

		setTimeout(function(){

		$("#product-page .pswp__scroll-wrap .pswp__item .pswp__img").closest("div").prepend('<div class="large-photo-clone"></div>');

		$("#product-page img.pswp__img").each(function(){

			$(this).siblings(".large-photo-clone").css("background", 'url('+$(this).attr("src")+')').width($(this).width()).height($(this).height());
...
$("#product-page .product-photo-slider .show-large-image, #product-page .pswp__scroll-wrap button").on("click", function(){

	productPhotoSliderSizer();
