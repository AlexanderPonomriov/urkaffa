<!-- Swiper-->
      <div data-height="" data-min-height="300px" data-simulate-touch="false" data-slide-effect="fade" class="swiper-container swiper-slider swiper-slider-main">
        <div class="swiper-wrapper">
			[!multiTV?
				&tvName=`mainSwiperImg`
				&docid=`[*id*]`
				&tplConfig=``
				&outerTpl=`@CODE:((wrapper))`
				&rowTpl=`@CODE:<div data-slide-bg="[+image+]" class="swiper-slide"></div>`

			!]
        </div>
        <div class="swiper-caption-absolute">
          <div class="shell main-swiper-text">
            <div class="range range-xs-center">
              <div class="cell-sm-10 cell-lg-12">
                ...
                <div class="offset-top-15 offset-md-top-0">
                  <div class="font-accent text-bold text-spacing-inverse-50 text-capitalize text-white text-spacing-75 swiper-slider-main-title">[*mainSwiperText*]</div>
                </div>
